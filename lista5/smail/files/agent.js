...
if (is_ie5up){ // IE5
  href="./files/master-style_ie5up.css";
  mhref="./files/mail_css_ie5win.css";
}

 else if (is_gecko) {// Netscape 6/7 or Mozilla
  href="./files/master-style_ns6up.css";
  mhref="./files/mail_css_ns6up.css";
}

 else if (is_nav4 && is_win) // Netscape 4 Windows
  href="./files/master-style_ns4win.css";
 
 else if (is_nav4 && is_sun) // Netscape 4 Solaris
  href="./files/master-style_ns4sol.css";
